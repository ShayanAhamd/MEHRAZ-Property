...
const DesSelStep1Screen2ProjectsCarouselMax = lazy(() =>
  import(
    "@/components/user-side/fast-homes/design-selection/DesSelStep1Screen2ProjectsCarouselMax"
  ),
);
...
const DesSelStep1Screen2ProjectsCarouselMin = lazy(() =>
  import(
    "@/components/user-side/fast-homes/design-selection/DesSelStep1Screen2ProjectsCarouselMin"
  ),
);
...
const DesSelStep1Screen2ProjectsCarouselMinMobile = lazy(() =>
  import(
    "@/components/user-side/fast-homes/design-selection/DesSelStep1Screen2ProjectsCarouselMinMobile"
  ),
);
