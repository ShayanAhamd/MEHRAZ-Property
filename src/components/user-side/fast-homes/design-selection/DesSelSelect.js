    ...
    <>
      <div
        ...
        <button
          ...
          className=" flex items-stretch rounded-full overflow-hidden border border-[#282828] border-opacity-60  h-[60px] lg:h-[70px] md:h-[50px] sm:h-[48px]  w-full ">
          <span
            className="bg-white text-[#000000a6] py-3 sm:py-2 text-small flex-1 flex justify-center items-center px-5
          ">
          ...
          <div className="w-max min-w-full absolute bottom-0 translate-y-full right-0 bg-white shadow-btn rounded-2xl border-2 border-accent-1-base py-2 pl-2 pr-1 z-[10] overflow-hidden">
            <div
              ...
              {options?.map(({ label, value }, index) => (
                <label
                  className={`flex items-center gap-3 p-2 normal-text  cursor-pointer hover:bg-black hover:bg-opacity-5 ${
